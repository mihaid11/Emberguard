	...
	mConfirmShowing(false), mAmountToWithdraw(0), mCrystals(crystals), mBankBalance(bankBalance)
{
	...
	mCrystalBalance.setPosition(sf::Vector2f(mMenuShape.getPosition().x + 60, mMenuShape.getPosition().y + 175));
	...
	mBalance.setPosition(sf::Vector2f(mMenuShape.getPosition().x + 60, mMenuShape.getPosition().y + 100));

	mAmount.setFont(mFont);
	mAmount.setCharacterSize(16);
	mAmount.setFillColor(sf::Color::White);
	mAmount.setString("Withdraw Amount: ");
	mAmount.setPosition(sf::Vector2f(mMenuShape.getPosition().x + 60, mMenuShape.getPosition().y + 25));

	m100Button.setPosition(sf::Vector2f(mMenuShape.getPosition().x + 300, 
		mMenuShape.getPosition().y + 25 - 8.75));
	m250Button.setPosition(sf::Vector2f(mMenuShape.getPosition().x + 300 + 110, 
		mMenuShape.getPosition().y + 25 - 8.75));
	m500Button.setPosition(sf::Vector2f(mMenuShape.getPosition().x + 300 + 220, 
		mMenuShape.getPosition().y + 25 - 8.75));
